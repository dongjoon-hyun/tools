...
app.get('/webhdfs/v1/:a/:b/:c/:d/:e/:f', function(req, res) {
   res.writeHead(200, {'Content-Type': 'image/jpeg'});
   res.write(fs.readFileSync('/hdfs/' + req.params.a + '/' + req.params.b + '/' + req.params.c + '/' + req.params.d + '/' + req.params.e + '/' + req.params.f));
   res.end()
});
